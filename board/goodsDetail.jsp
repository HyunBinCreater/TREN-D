...
<main class="container" style="height:600px;">
	...
	<div class="content_box">
		<div class="content_img">
			...
			<img src="/trendproject/images/board/mainbag.jpg" alt="상품이미지" style="width:300px;height:500px;">
			 <span style="font-size:26px;color:#454545;">></span>
		</div>
	
		<div class="content_tbl">
			<div class="p_container">
			<span class="p_text">브렌드 > </span> <!-- 카테고리 표시 -->
				<p class="icon_p">
				<!-- 찜 -->
	...
	<!-- 상품 정보 등록 -->		
			<p>여성 흰색 가방</p>
			<p>해외배송 ★5(1)</p>
			<p style="font-size:18px;color:#9900cc;">48% <span style="color:#ccc;text-decoration:line-through"> 91,540</span></p>
			<p style="font-size:20px;font-weight:bold;color:#000;margin-left:20px;">47,214원</p>
			<select name="size">
			
				<option value="" selected>[LK]ONE SIZE</option>
