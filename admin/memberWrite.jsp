	...
	<table>
		...
		<tr>
			...
			<td>
				...
				<input type="text" name="postcode" id="postcode" class="frm_input" size="8" maxlength="5">
				<button type="button" class="btn_small" onclick="fn_postcode()">주소검색</button>
				
				<br>
				
				<input type="text" name="loadaddr" id="loadaddr" class="frm_input frm_address" size="60"> <br>
				<input type="text" name="etcaddr" id="etcaddr" class="frm_input frm_address" size="60">
